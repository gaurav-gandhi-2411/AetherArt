...
**Japanese woodblock-print art generated by a fine-tuned AI model — running live on a GPU in the cloud.**
...
<p align="center">
  <img src="reports/lora_training_summary_sdxl_samples/ckpt1000_mount-fuji-sunset.png" width="600" alt="AI-generated ukiyo-e woodblock print of Mount Fuji at sunset">
  <br>
  <em>Generated by AetherArt — SDXL + Ukiyo-e LoRA, seed 42, 25 steps</em>
</p>
...
I took Stable Diffusion 2.1, an older open-source image-generation model, and upgraded it to Stable Diffusion XL — a more powerful model that most laptops can't run comfortably. To make it fit on a standard 8 GB laptop GPU, I implemented a set of memory-optimization techniques. I then trained it to produce Japanese woodblock-print art (ukiyo-e) by fine-tuning it on 80 WikiArt images, and deployed it as a live demo you can try right now.

This is a research project, not a product — every architectural decision was made to understand *why* it works, and the findings include at least one case where I had to go back and correct an earlier claim.

---

## Try it

**[→ Open the live demo](https://aetherart-demo-473907703523.us-central1.run.app)**

Type a prompt like: `ukyowood ukiyo-e woodblock print of Mount Fuji at sunset`

The trigger word `ukyowood` activates the woodblock-print style. Without it you get standard SDXL output. Fast mode (Hyper-8step) is on by default — ~8 s/image. Cold start is ~5–7 min on first load while the model downloads.

---

## Gallery

All four images generated at seed 42, checkpoint-1000, 25 steps, 1024×1024.

<table>
  <tr>
    <td align="center">
      <img src="reports/lora_training_summary_sdxl_samples/ckpt1000_mount-fuji-sunset.png" width="380" alt="Mount Fuji at sunset"><br>
      <em>"ukyowood ukiyo-e woodblock print of Mount Fuji at sunset"</em>
    </td>
    <td align="center">
      <img src="reports/lora_training_summary_sdxl_samples/ckpt1000_crane-ocean-waves.png" width="380" alt="Crane over ocean waves"><br>
      <em>"ukyowood ukiyo-e print of a crane over ocean waves"</em>
    </td>
  </tr>
  <tr>
    <td align="center">
      <img src="reports/lora_training_summary_sdxl_samples/ckpt1000_samurai-bamboo.png" width="380" alt="Samurai in bamboo forest"><br>
      <em>"ukyowood ukiyo-e woodblock print of a samurai in a bamboo forest"</em>
    </td>
    <td align="center">
      <img src="reports/lora_training_summary_sdxl_samples/ckpt1000_cherry-blossoms-river.png" width="380" alt="Cherry blossoms along a river"><br>
      <em>"ukyowood ukiyo-e print of cherry blossoms along a river"</em>
    </td>
  </tr>
</table>
