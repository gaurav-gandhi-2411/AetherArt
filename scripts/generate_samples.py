...
def generate_controlnet_depth():
    ...
    depth_prompts = [
        (
            "mountain_valley",
            "a lush mountain valley at dawn, mist rolling through the trees, sunrise",
        ),
...
if __name__ == "__main__":
    ...
    total = sum(
        len(list((SAMPLES_DIR / t).glob("*.png")))
        for t in [
            "standard_fp16",
            "lcm",
            "turbo",
